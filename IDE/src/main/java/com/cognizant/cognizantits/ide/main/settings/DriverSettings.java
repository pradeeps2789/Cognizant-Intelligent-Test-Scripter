...
//        }
            ...
            .addGroup(emulatorPanelLayout.createSequentialGroup()
                ...
                .addGroup(emulatorPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(emulatorPanelLayout.createSequentialGroup()
                        ...
                        .addComponent(resolution, javax.swing.GroupLayout.PREFERRED_SIZE, 108, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void chromeEmulatorHintMouseClicked(java.awt.event.MouseEvent evt) {                                                
    ...
    private void duplicateEmulatorItemStateChanged(java.awt.event.ItemEvent evt) {                                                   
        dupDriverCombo.setEnabled(duplicateEmulator.isSelected());
    }                                                  

    private void uaEmulatorItemStateChanged(java.awt.event.ItemEvent evt) {                                            
    ...
    private void chromeEmulatorItemStateChanged(java.awt.event.ItemEvent evt) {                                                
        chromeEmulatorList.setEnabled(chromeEmulator.isSelected());
    }                                               

    private void appiumEmulatorItemStateChanged(java.awt.event.ItemEvent evt) {                                                
        appiumConnectionString.setEnabled(appiumEmulator.isSelected());
    }                                               

    private void browserComboItemStateChanged(java.awt.event.ItemEvent evt) {                                              
    ...
    private void editEmulatorActionPerformed(java.awt.event.ActionEvent evt) {                                             
        renameEmulator();
    }                                            

    private void deleteEmulatorActionPerformed(java.awt.event.ActionEvent evt) {                                               
        deleteEmulator();
    }                                              
    ...
    private void removePropButtonActionPerformed(java.awt.event.ActionEvent evt) {                                                 
    ...
    private void addCapActionPerformed(java.awt.event.ActionEvent evt) {                                       
        DefaultTableModel model = (DefaultTableModel) capTable.getModel();
        model.addRow(new Object[]{});
    }                                      

    private void removeCapActionPerformed(java.awt.event.ActionEvent evt) {                                          
    ...
    private void resetSettingsActionPerformed(java.awt.event.ActionEvent evt) {                                              
        // TODO add your handling code here:
    }                                             

    private void defaultAppiumActionPerformed(java.awt.event.ActionEvent evt) {                                              
        String selBrowser = browserCombo.getSelectedItem().toString();
        Emulator emulator = settings.getEmulators().getEmulator(selBrowser);
        if (emulator != null) {
    ...
    private void configProxyActionPerformed(java.awt.event.ActionEvent evt) {                                            
        DefaultTableModel model = (DefaultTableModel) driverPropTable.getModel();
    ...
    private void syncChromeEmulatorsActionPerformed(java.awt.event.ActionEvent evt) {                                                    
